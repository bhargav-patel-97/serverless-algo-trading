 ...
 * FIXED: Added missing methods to resolve function call errors
 */
...
export default class EnhancedTradingPositionManager {
  ...
  /**
   * FIXED: Alias method for backward compatibility with existing trade.js calls
  ...
  /**
   * FIXED: Added missing methods for cooldown functionality
   */
  getAllCooldowns() {
    try {
