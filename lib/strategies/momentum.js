// lib/strategies/momentum.js - Enhanced Momentum Trading Strategy with SPY/QQQ Support
...
export class MomentumStrategy {
  constructor(config) {
    this.config = {
      ...
      name: config.name || 'Momentum Strategy',
      baseSymbol: config.baseSymbol || 'SPY', // SPY or QQQ
      symbols: config.symbols || ['TQQQ', 'SQQQ'], // Leveraged ETFs to trade
  ...
  async generateSignals(alpaca) {
    ...
    try {
      ...
      // Get base symbol data (SPY or QQQ) for market direction
